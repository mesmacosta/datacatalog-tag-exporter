...
# Service Account credentials file named datacatalog-tag-exporter.json.
ENV GOOGLE_APPLICATION_CREDENTIALS=/credentials/datacatalog-tag-exporter-sa.json
...
ENTRYPOINT ["datacatalog-tag-exporter"]
